...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { fec_conc: @concert.fec_conc, fecha: @concert.fecha, hora_fin: @concert.hora_fin, hora_ini: @concert.hora_ini }
    end
  ...
  test "should update concert" do
    put :update, id: @concert, concert: { fec_conc: @concert.fec_conc, fecha: @concert.fecha, hora_fin: @concert.hora_fin, hora_ini: @concert.hora_ini }
    assert_redirected_to concert_path(assigns(:concert))
  end
